...
public class PaperExamplesGenerator {
    ...
    private void generateTraces(String fileName) throws IOException {
        ...
        traces.add(this.buildBatchTrace(456));
        traces.add(this.buildContractCreationTrace(789));
    ...
    private EventTrace buildContractCreationTrace(long traceId) {
        ...
        var holderRoleEntity = new Entity("Holder Role", "234");
        var ownerRoleEntity = new Entity("Car Owner Role", "345");
        var ownerEntity = new Entity("Person", "567");
        var componentEntity1 = new Entity("Car Contract Component", "2345");
        var componentEntity2 = new Entity("Car Contract Component", "3456");
