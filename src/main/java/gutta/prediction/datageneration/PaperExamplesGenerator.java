...
/**
 * Trace generator to produce traces based on the example from the paper.
 */
public class PaperExamplesGenerator {
    ...
    private EventTrace buildContractCreationTrace(long traceId) {
        ...
        return EventTrace.of(//
                new UseCaseStartEvent(traceId, 0, location, useCaseName), new ServiceCandidateInvocationEvent(traceId, 10, location, carCreationServiceName),
                ...
                new EntityWriteEvent(traceId, 40, location, genericContractEntity), new EntityWriteEvent(traceId, 45, location, holderRoleEntity),
                new EntityWriteEvent(traceId, 50, location, ownerRoleEntity), new EntityReadEvent(traceId, 80, location, ownerEntity),
                new ServiceCandidateInvocationEvent(traceId, 90, location, updateCustomerFlagServiceName),
                new ServiceCandidateEntryEvent(traceId, 90, location, updateCustomerFlagServiceName), new EntityWriteEvent(traceId, 100, location, ownerEntity),
                ...
                new EntityWriteEvent(traceId, 150, location, componentEntity1), new EntityWriteEvent(traceId, 170, location, componentEntity2),
                new ServiceCandidateInvocationEvent(traceId, 200, location, registerSaleServiceName),
                new ServiceCandidateEntryEvent(traceId, 200, location, registerSaleServiceName), new EntityReadEvent(traceId, 220, location, ownerEntity),
                ...
                new ServiceCandidateReturnEvent(traceId, 280, location, carCreationServiceName), new UseCaseEndEvent(traceId, 300, location, useCaseName));
    }
    ...
    private EventTrace buildFailingContractCreationTrace(long traceId) {
        ...
        return EventTrace.of(//
                ...
                new ServiceCandidateReturnEvent(traceId, 180, location, carCreationServiceName), new UseCaseEndEvent(traceId, 200, location, useCaseName));
    }
