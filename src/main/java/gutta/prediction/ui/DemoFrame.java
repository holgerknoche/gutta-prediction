...
class DemoFrame extends JFrame {	
	...
	private static class SimpleTraceComponent extends TraceComponent {
		...
		private final List<DrawableShape> shapes = Arrays.asList(
				new TransactionMarkerShape(150, 10, 200, TransactionState.CLEAN),				
				new TransactionMarkerShape(200, 10, 300, TransactionState.DIRTY),
				new SpanShape(100, 20, 500),
				new TransactionEventShape(150, 25, EventType.READ),
				new TransactionEventShape(200, 25, EventType.WRITE),
	...
	private static class DistributedTraceComponent extends TraceComponent {
		...
		private final List<DrawableShape> shapes = Arrays.asList(
				...
				new TransactionMarkerShape(130, 0, 150, TransactionState.CLEAN),
				new TransactionMarkerShape(150, 0, 200, TransactionState.DIRTY),
				new TransactionMarkerShape(200, 0, 450, TransactionState.SUSPENDED),
				new TransactionMarkerShape(450, 0, 500, TransactionState.DIRTY),
				
				new SpanShape(100, 10, 500),

				new TransactionEventShape(130, 15, EventType.READ),
				new TransactionEventShape(150, 15, EventType.WRITE),
				new TransactionEventShape(500, 15, EventType.ABORT),
				  
				// Service B
				
				new TransactionMarkerShape(200, 50, 310, TransactionState.CLEAN),
				new TransactionMarkerShape(310, 50, 450, TransactionState.DIRTY),
				new TransactionMarkerShape(450, 50, 500, TransactionState.SUSPENDED),

				new SpanShape(200, 60, 450),
				
				new TransactionEventShape(270, 65, EventType.STALE_READ),
				new TransactionEventShape(310, 65, EventType.CONFLICTING_WRITE),
				
				// Service C
				
				new TransactionMarkerShape(250, 100, 300, TransactionState.CLEAN),
				new PrependedLatencyShape(220, 110, 250),
				new SpanShape(250, 110, 300),
